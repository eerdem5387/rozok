...
/** Bu form yalnızca Özel Bilge ortaokulu adayları içindir. */
const SCHOOL_NAME = "RİZE - GÜNEYSU - ÖZEL BİLGE ORTAOKULU";
const inputClass =
...
export default function BilgeOrtaokuluBasvuruPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch("/api/bilge-ortaokulu-basvuru", {
        method: "POST",
    ...
    <main className="container mx-auto px-4 md:px-6 py-10">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-xl p-8 border border-slate-100 dark:border-slate-800">
          <h1 className="text-2xl font-bold mb-8">Özel Bilge Ortaokulu — Başvuru Formu</h1>
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input id="tcKimlik" name="tcKimlik" required maxLength={11} pattern="[0-9]{11}" className={inputClass} />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input id="fatherPhone" name="fatherPhone" type="tel" required pattern="0?5[0-9]{9}" className={inputClass} />
              </div>
              <div>
              ...
              <div>
                ...
                <input id="motherPhone" name="motherPhone" type="tel" required pattern="0?5[0-9]{9}" className={inputClass} />
              </div>
              <div>
